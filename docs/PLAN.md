...
`$ENTRY` visibility markers on exported source definitions, with an end-to-end generated-source
check and runtime execution through the generated `Go` wrapper. The frontend negative corpus
