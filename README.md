...
**Not yet done (~20% of 1.0 target):** heap-allocated single view field (issue
...
bracket contents in the format lattice; `driver.ref`; native code generation (§4.7, deliberately after self-hosting).
