...
| 7 | Compiler written in Refal | 🔶 Partial | Refal-authored fixtures now cover restricted identity, forwarding-call, literal, mixed call/literal, repeated-name checker, two-literal, and recursive multi-definition identity/literal compilation; they generate checked Refal source and execute through the bootstrap runtime. General Classic Refal parsing, driven Core Refal emission, and compiler completeness remain open |
